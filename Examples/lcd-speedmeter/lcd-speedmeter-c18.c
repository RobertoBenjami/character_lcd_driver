...
void main(void)
{
  ...
  // memcpypgm2ram((char *)LcdText, " LCD CPU used       meter       ", 32); // kezdõképernyõ feltöltése
  #else  // (1UL * LCDWIDTH * LCDLINES) < 80
  // 4x40 karakteres -------------------
  //                                   "0204060810121416182022242628303234363840"
  memcpypgm2ram((char *)LcdText +   0, "****************************************", 40); // kezdõképernyõ feltöltése
  memcpypgm2ram((char *)LcdText +  40, "*            LCD speed meter           *", 40); // kezdõképernyõ feltöltése
  memcpypgm2ram((char *)LcdText +  80, "*                                      *", 40); // kezdõképernyõ feltöltése
  memcpypgm2ram((char *)LcdText + 120, "****************************************", 40); // kezdõképernyõ feltöltése
  #endif // else (1UL * LCDWIDTH * LCDLINES) < 80
